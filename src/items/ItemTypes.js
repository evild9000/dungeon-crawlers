...
export const CONSUMABLES = {
    ...
    material_construct_heart: {
        ...
        category: ITEM_CATEGORY.CONSUMABLE,
        description: 'A pulsing core salvaged from a construct.',
        icon: '\u{2699}\uFE0F',
        stackable: true,
    },
    material_construct_head: {
        ...
        name: 'Construct Head',
        category: ITEM_CATEGORY.CONSUMABLE,
        description: 'An intact construct cranial housing.',
        icon: '\u{1F916}',
        stackable: true,
    },
    material_construct_arm: {
        ...
        name: 'Construct Arm',
        category: ITEM_CATEGORY.CONSUMABLE,
        description: 'A reinforced construct limb segment.',
        icon: '\u{1F9BE}',
        stackable: true,
    },
    material_construct_leg: {
        ...
        name: 'Construct Leg',
        category: ITEM_CATEGORY.CONSUMABLE,
        description: 'A heavy construct locomotion limb.',
        icon: '\u{1F9BF}',
        stackable: true,
    },
    material_construct_torso: {
        id: 'material_construct_torso',
        name: 'Construct Torso',
        category: ITEM_CATEGORY.CONSUMABLE,
        description: 'A construct torso frame with mounting points.',
        icon: '\u{1F9F1}',
        stackable: true,
    },
