...
export const CLASSES = {
    ...
    mage: {
        ...
        special: null,
        description: 'Arcane caster. -25% HP/ST, +50% mana. +1 magic, +2 MP regen. Cloth armor only; cannot use shields. Per level: +1 magic, +1% chance to stun foes with magic, and +1% magic/AoE defense penetration (ignores enemy defense by mage level%). L25: Summon Familiar outside combat with F; the familiar levels up to mage level - 24, costs 10,000 gold per new level, and grants +10% magic/AoE damage plus +1 defense per familiar level.',
    },
    rogue: {
        id: 'rogue',
        name: 'Rogue',
    ...
    necromancer: {
        ...
        special: 'summon',
        description: 'Dark caster. -25% HP, -50% ST, +75% mana. Cloth armor only; cannot use shields. Summon undead (7 MP, combat only) — L1 Skeleton, then Zombie / Ghoul / Spectre / Mummy / Ghost / Vampire / Death Knight unlocked at odd levels. Life drain (25% per enemy hit by magic) heals self AND own undead; +1 per level. L25: while in Lich Form, summon a Demi-Lich for 20 MP — back-row undead caster with defense-ignoring AoE magic, Ghost Fear, half magic/AoE damage, and immunity to stun/web/holds/poison.',
    },
    bard: {
    ...
    druid: {
        ...
        magicPerLevel: 1, // +1 magic damage per level beyond 1
        special: 'druid',
        description: 'Nature caster. -15% HP/ST, +30% mana. Cloth/leather armor only (no chain or plate). Entangle (8 MP): vines target all enemies, each with 50% chance to suffer -2 defense and -2 damage (scales +1 at levels 3, 5, 7…). Also summons a Woodland Beast like the ranger (7 MP). Per level: +1 magic damage. L25: Shambling Mound (100 MP) — 4× druid max HP, 20+druid level defense, stunning slam, 20% regen, mini-shambler growth (not on the summon round), and only the original mound can bud new minis (grown minis cannot). Intercepts hits aimed at its druid.',
    },
    barbarian: {
        id: 'barbarian',
        name: 'Barbarian',
