...
export const CLASSES = {
    ...
    artificer: {
        ...
        special: 'artificer',
        description: 'Inventor & golem-smith. +50% ST, -50% mana. +1 ranged, +2 ST regen. Cloth/leather only; no shields. Scatter Shot: ranged hit spreads to 2 splash targets at (50%+level)% damage, capped at 100% (+1 splash every 5 levels), each with its own crit. Press [K] to craft: enchant weapons/armor, brew healing and mana potions, scribe party-wide Scrolls of Warding/Wrath, craft L35 magic-item charges, and build permanent golems. Repairing a golem has artificer level × 2% chance to cost no reagent. Per level: +1 ranged. L25: Advanced Augments — add separate vitality and regen augments to level 4+ trinkets and install golem attachments: extra limbs, golem shields, and golem trinkets. L25: Enchanted Drone — each scatter splash has a (level)% chance (cap 75%) to spawn a drone with random support or offense effects. L25: Deconstruct (passive) — Scatter Shot gains +20% + level/2% crit chance against constructs and deals ×3 armor-ignoring bonus damage; 50% chance per hit to scavenge parts and repair your own golem(s) for 5% max HP. L35: Magic Items — use monster materials to craft Cloak of Displacement, Horn of Valhalla, Pipes of the Sewers, and Demon Pentagram charges for combat. L35: Sabotage (passive) — each construct hit adds sabotage counters; each counter rolls a (level/33)% instant-destroy check immediately (bosses/mega-bosses/super-bosses immune). Sabotage kills fully repair your own golems. L30: Golem Berserk Mode (free action, once per golem per combat) — overclock a golem to deal ×(1 + artificer level × 2%) damage; the golem takes 2% of its current HP as self-damage each round and auto-disengages at 10% max HP. L30: Multi Golem Protocol — maintain up to 2 simultaneous golems (3 at L50, 4 at L70, 5 at L90). L35: Dual Drone (passive) — when a splash procs a drone, roll one extra drone proc at the same chance.',
    },
    paladin: {
