...
export const CLASSES = {
    ...
    necromancer: {
        ...
        special: 'summon',
        description: 'Dark caster. -25% HP, -50% ST, +75% mana. Cloth armor only; cannot use shields. Summon undead (7 MP, combat only) — L1 Skeleton, then Zombie / Ghoul / Spectre / Mummy / Ghost / Vampire / Death Knight unlocked at odd levels. Life drain (25% per enemy hit by magic) heals self AND own undead; +1 per level. L20: Lich Form — transforms into a lich with a phial as a life-anchor; on death the soul retreats into the phial for 3 rounds then revives at 50%+ HP. Lich Form grants resistance to magic/AoE, immunity to poison/stun/paralysis/mummy rot, and lets you summon a Demi-Lich (20 MP). L25: while in Lich Form, summon a Demi-Lich for 20 MP — back-row undead caster with defense-ignoring AoE magic, Ghost Fear, half magic/AoE damage, and immunity to stun/web/holds/poison. L30: Dark Apotheosis — unleash two powers. Corpse Horror: the entire party shares ONE Corpse Horror; every enemy killed during combat (by anyone) feeds the single horror; its HP, defense, and attack count scale with total corpse count, and its power is keyed to the highest-level qualifying necromancer in Lich Form. Plague Bringer (35 MP): infect all living enemies with a necromantic plague — each infected enemy\'s damage ticks spread to adjacent enemies; undead are immune.',
    },
    bard: {
