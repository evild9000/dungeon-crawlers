...
export const CLASSES = {
    ...
    ranger: {
        ...
        description: 'Skilled bowman. +25% HP/ST, -50% mana. +1 ranged, +1 HP/ST regen. Cloth/leather/chain armor (no plate). Shields OK — but equipping a ranged weapon auto-unequips a shield. Per level: +1 ranged, +3% ranged crit. Normal ranged attacks fire 1 + floor(level/5) arrows (L5 = 2, L10 = 3, etc.); Wolf Totem adds +1 more arrow. Each shot pays stamina and rolls its own crit. Ranger crits deal normal 2× damage, then +level×2% more damage; this stacks with Favored Enemy damage. Summon Woodland Beast (7 MP, 2 MP/round per beast including each wolf in a pack): wolf, bear, eagle, or pixie. Choose a Favored Enemy: ignore its defense, deal +level×2% ranged damage, and gain 1%/3 levels instakill chance (bosses/mega-bosses are immune to instant death; triggered procs deal x4 ranged damage instead; extra shots after the first roll half chance). L20: Explosive Arrow (6 ST) — one arrow detonates among ALL enemies for half post-defense damage each, reduced crit chance, one-third instakill vs favored (boss/mega-boss procs convert to x4 damage instead of instant death). L20+: unlock extra Favored Enemy slots every 5 levels (+1 at L20, +2 at L25, etc.). L25: Animal Totem — free combat stance costing 5 MP/round; Wolf adds bleed and +1 extra ranged attack each round, Bear adds stun/defense, Eagle adds damage and ranged deflection (checked before warrior/shambling intercept), Pixie adds poison and magic/AoE resistance. L30: Hunter\'s Mark — stamina and mana upkeep each round; marked target takes +10% damage. L30: Beastlord — free toggle (5 MP/round base, +2 MP/round per beastlord beast) that auto-summons woodland beasts each round. L35: Beast Mastery (passive) — bond with a permanent beast companion out of combat [P key]; select from 7 types (Dire Wolf, Cave Bear, Roc, Sabre Tooth Cat, Mega-conda, Megaloceros, Sasquatch); beast stats scale with ranger level (HP = ranger maxHP × 1.5, ATK/DEF = level × 3, damage +ranger level%); if the beast dies, revive it for level × 100 gold. Changing companion type is always free. L35: Ricochet Shot (passive) — every normal ranged arrow from the 1 + floor(level/5) arrow sequence (plus Wolf Totem arrow, if active) can start its own ricochet chain against other enemies; the chain chance starts at 75% and drops by 10% after each successful ricochet (75%, 65%, 55%, 45%, 35%, 25%, 15%, 5%), stopping on the first failure. Each ricochet costs 1 MP, rerolls fresh ranged damage against its target at 50% damage, can crit at normal crit chance, can instakill favored enemies at one-third of normal chance, and applies weapon riders and totem effects; does NOT apply to Explosive Arrows. Crafted Manticore Ballista (Artificer L35) is a ranger/artificer ranged weapon with +7 ranged, +5% crit chance, +15% critical damage, +5% per Ricochet cascade step, +2 Scatter Shot targets, and prone on core ranged/scatter targets.',
    },
    mage: {
        id: 'mage',
        name: 'Mage',
    ...
    necromancer: {
        ...
        special: 'summon',
        description: 'Dark caster. -25% HP, -50% ST, +75% mana. Cloth armor only; cannot use shields. Summon undead (4-7 MP by tier, combat only; 2 MP/round per undead, including vampire-summoned bats or wolves) — L1 Skeleton, then Zombie / Ghoul / Spectre / Mummy / Ghost / Vampire / Death Knight unlocked at odd levels. Necromancer vampires prioritize bleeding foes, gaining +10% damage per bleed DoT stack and double Life Drain healing against bleeding prey; their vampire bats also prioritize bleeding foes and gain +2% damage per bleed DoT stack. Life Drain (25% per enemy hit by magic) heals that necromancer\'s own undead for 5% + level/2% of each undead minion\'s max HP. L20: Lich Form — transforms into a lich with a phial as a life-anchor; on death the soul retreats into the phial for 3 rounds then revives at 50%+ HP. Lich Form grants resistance to magic/AoE, immunity to poison/stun/paralysis/mummy rot, lets you summon a Demi-Lich (10 MP), and Life Drain also heals the lich-form necromancer for 5% of the magic damage dealt by that hit. L25: while in Lich Form, summon a Demi-Lich for 10 MP — back-row undead caster with defense-ignoring AoE magic scaling by floor((level/3)^2 × 2), Ghost Fear, half magic/AoE damage, and immunity to stun/web/holds/poison. L30: Dark Apotheosis — unleash two powers. Corpse Horror: the entire party shares ONE Corpse Horror; every enemy killed during combat (by anyone) feeds the single horror; its HP grows with corpse count, attacks/round cap at necromancer level, melee skill caps at level×10, and defense caps at level×5. Plague Bringer (35 MP): infect all living enemies with a necromantic plague — each infected enemy\'s damage ticks spread to adjacent enemies; undead are immune. L35: Control the Dead (50 MP) dominates one undead enemy using bard-style charm chance and duration while bypassing undead charm immunity (bosses remain immune). L35: Siphon Power is passive — necromancer magic attacks fold the old Siphon Power into Life Drain, draining each vulnerable enemy hit for level/2 to level×2 ST and MP; undead, constructs, elementals, and drain-immune enemies are immune. Crafted Staff of Necromancy (Artificer L35) reduces Lich Phial return to 2 rounds, gives summoned undead +25% damage, increases necromancer magic/AoE damage by 50%, doubles life-drain healing to controlled undead, and adds +5% to Control the Dead.',
    },
    bard: {
