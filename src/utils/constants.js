...
export const ADVANCED_MATERIAL_DROP_CHANCE    = 0.60;
...
export const ROGUE_EXTRA_LOOT_GOLD_PCT          = 100; // base gold bonus per living L35+ rogue
// Extra Loot gold bonus = +(100 + rogue level)% per living L35+ rogue, additive across rogues
...
export const RANGER_BEAST_COMPANION_TYPES = {
    ...
    cave_bear:   { id: 'cave_bear',   summonType: 'bc_cave_bear',   beastKind: 'bc_cave_bear',
        name: 'Cave Bear',       icon: '🐻', enemySprite: 'cave_bear', row: 'front', attackType: 'melee',
    ...
    sasquatch:   { id: 'sasquatch',   summonType: 'bc_sasquatch',   beastKind: 'bc_sasquatch',
        name: 'Sasquatch',       icon: '🦍', enemySprite: 'dungeon_ape', row: 'front', attackType: 'melee',
...
export const WARLOCK_L35_UNLOCK_LEVEL = 35;
export const WARLOCK_HOOKED_TENTACLE_CRIT_PER_LEVEL = 0.01;
export const WARLOCK_HOOKED_TENTACLE_CRIT_BONUS_BASE = 1.0; // +100%
export const WARLOCK_HOOKED_TENTACLE_CRIT_BONUS_PER_LEVEL = 0.02; // +2% per level
export const WARLOCK_HOOKED_TENTACLE_BLEED_BASE_CHANCE = 0.33;
export const WARLOCK_HOOKED_TENTACLE_BLEED_CHANCE_PER_LEVEL = 0.01;
export const WARLOCK_HOOKED_TENTACLE_BLEED_ROUNDS_DIVISOR = 7;
export const WARLOCK_AWAKEN_TRIGGER_SUMMONS = 5;
...
export const PHOTOMANCER_DISINTEGRATE_BASE_DAMAGE_BONUS = 3.00;
export const PHOTOMANCER_DISINTEGRATE_DAMAGE_PER_LEVEL = 0.03;
export const PHOTOMANCER_DISINTEGRATE_EXTRA_BEAM_EVERY = 10;
export const PHOTOMANCER_DISINTEGRATE_EXTRA_BEAM_START_LEVEL = 20;
export const PHOTOMANCER_DISINTEGRATE_BASE_KILL = 0.03;
export const PHOTOMANCER_DISINTEGRATE_KILL_PER_LEVEL = 0.005;
...
export const PHOTOMANCER_L35_UNLOCK_LEVEL = 35;
export const PHOTOMANCER_RADIANT_BURST_MANA_COST = 75;
export const PHOTOMANCER_RADIANT_BURST_BLIND_ROUNDS = 2;
export const PHOTOMANCER_RADIANT_BURST_BLIND_LOCKOUT_ROUNDS = 2;
export const PHOTOMANCER_RADIANT_BURST_BOSS_BLIND_CHANCE = 0.20;
export const PHOTOMANCER_RADIANT_BURST_BLIND_MISS_CHANCE = 0.50;
export const PHOTOMANCER_RADIANT_BURST_IMMUNE_TAGS = ['construct', 'elemental', 'undead', 'plant', 'slime'];
export const PHOTOMANCER_ETERNAL_RAINBOW_MANA_COST = 100;
export const PHOTOMANCER_RAINBOW_RED_HP_REGEN = 0.10;
export const PHOTOMANCER_RAINBOW_ORANGE_RESOURCE_REGEN = 0.05;
export const PHOTOMANCER_RAINBOW_STAT_DIVISOR = 5;
export const PHOTOMANCER_RAINBOW_BLUE_REVIVE_DIVISOR = 10;
export const PHOTOMANCER_LEPRECHAUN_HP_MULT = 2;
export const PHOTOMANCER_LEPRECHAUN_DEFENSE_PER_LEVEL = 2;
export const PHOTOMANCER_LEPRECHAUN_MAGIC_PER_LEVEL = 2;
export const PHOTOMANCER_LEPRECHAUN_GLAMOUR_STEP = 0.05;
export const PHOTOMANCER_LEPRECHAUN_CURSE_DIVISOR = 3;
export const PHOTOMANCER_LEPRECHAUN_GREED_MIN = 2;
export const PHOTOMANCER_LEPRECHAUN_GREED_MAX = 8;
